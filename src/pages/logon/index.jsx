...
import { Container, Title, Column, TitleLogin, SubtitleLogin, CriarText, Row, Wrapper, TemConta } from './styles';
            ...
            <Column>
                <Wrapper>
                    ...
                    <Input placeholder="Nome Completo" leftIcon={<MdPerson />} name="nome" control={control} />
                        ...
                        <Button title="Fazer Login" variant="secondary" type="submit" />
                    </form>
                    <Row>
